...
class TestDeepTable:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "deeptable/_legacy_response.py",
                        "deeptable/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "deeptable/_compat.py",
    ...
    def test_hardcoded_query_params_in_url(self, client: DeepTable) -> None:
...
class TestAsyncDeepTable:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncDeepTable) -> None:
