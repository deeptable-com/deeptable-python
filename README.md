...
pip install git+ssh://git@github.com/stainless-sdks/deeptable-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install deeptable`
...
```sh
# install from this staging repo
pip install 'deeptable[aiohttp] @ git+ssh://git@github.com/stainless-sdks/deeptable-python.git'
```
...
The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/deeptable-python/tree/main/src/deeptable/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/deeptable-python/issues) with questions, bugs, or suggestions.
